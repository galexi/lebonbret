...
CREATE TABLE `rdv` (
  ...
  PRIMARY KEY (`id_r`),
  KEY `fk_1236` (`id_l`),
  CONSTRAINT `fk_1236` FOREIGN KEY (`id_l`) REFERENCES `lieu` (`id_l`)
...
INSERT INTO `rdv` VALUES (1,'2018-04-04 18:00:00','Changement de la CM de Géraldine',0,3),(2,'2018-04-08 15:30:00','Massif de rosier chez Patrice ',1,5);
...
-- Dump completed on 2018-03-28 12:00:34
